...
const variantStyles: Record<Variant, string> = {
  primary:
    "bg-accent text-accent-on font-semibold shadow-[0_0_24px_var(--accent-shadow)] hover:shadow-[0_0_32px_var(--accent-shadow-hover)] hover:brightness-110 active:brightness-90",
  outline:
    "border border-accent/50 text-accent bg-transparent hover:bg-accent/10 hover:border-accent active:bg-accent/15",
  ghost:
    "text-content-secondary bg-transparent hover:text-accent hover:bg-content/5 active:bg-content/10",
};
